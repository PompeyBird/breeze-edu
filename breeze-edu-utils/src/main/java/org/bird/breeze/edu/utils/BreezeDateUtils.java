...
public class BreezeDateUtils {
    ...
    private final static String TIME_SPACE = " ";
    private final static String TIME_SECONDS = ":00";
    ...
    public static Date paraDate(String dateStr, Integer format){
        Date date = null;
        try{
            switch (format){
                case 0: date = DateUtils.parseDate(dateStr, DATE_FORMAT); break;
                case 1: date = DateUtils.parseDate(dateStr, DATE_FORMAT_CN); break;
                case 2: date = DateUtils.parseDate(dateStr, TIME_FORMAT); break;
                case 3: date = DateUtils.parseDate(dateStr, TIME_FORMAT_CN); break;
                case 4: date = DateUtils.parseDate(dateStr, MONTH_FORMAT); break;
                case 5: date = DateUtils.parseDate(dateStr, DAY_FORMAT); break;
                default: date = DateUtils.parseDate(dateStr, DATE_FORMAT); break;
            }
        }catch (ParseException e) {
            e.printStackTrace();
        }
    ...
    public static Date paraDateTime(String dateStr, String timeStr, Integer format){
        Date date = null;
        try{
            String dateTimeStr = dateStr + TIME_SPACE + timeStr + TIME_SECONDS;
            switch (format){
                case 0: date = DateUtils.parseDate(dateTimeStr, TIME_FORMAT); break;
                case 1: date = DateUtils.parseDate(dateTimeStr, TIME_FORMAT_CN); break;
                default: date = DateUtils.parseDate(dateTimeStr, TIME_FORMAT); break;
            }
    ...
    public static Date getOffestDate(Date date, int dim,int offset) {

        Calendar cal = DateUtils.toCalendar(date);
        switch (dim){
            case Calendar.YEAR:
                cal.add(Calendar.YEAR, offset);break;
            case Calendar.MONTH:
                cal.add(Calendar.MONTH, offset);break;
            case Calendar.DATE:
                cal.add(Calendar.DATE, offset);break;
            case Calendar.HOUR:
                cal.add(Calendar.HOUR, offset);break;
            case Calendar.MINUTE:
                cal.add(Calendar.MINUTE, offset);break;
            case Calendar.SECOND:
                cal.add(Calendar.SECOND, offset);break;
        }
